  ...
  return (
    <section>
      ...
      <div className="flex flex-col gap-[18px] mt-[18px] px-[0px] lg:max-w-[943px] mx-auto">
        <P className='text-lg wrap-break-word'>It is important to be realistic about the many personal and practical challenges that come with platinum-resistant ovarian cancer. Be sure to talk openly with your care team about how you are feeling and if you need help coping with challenges, such as:</P>
      </div>
            ...
            <div className="flex flex-col gap-8 lg:hidden">
              {data?.map((item) => (
                <div className="flex flex-col items-center text-center" key={item.id}>
                  ...
                  <p className="font-mundial text-base font-light text-[#231D06] leading-[140%] tracking-[0.48px]" style={{ maxWidth: item.width }}>
                    {item.description}
                  </p>
                </div>
              ))}
